...
C:\#servers\v-rising\VRisingServer.exe -persistentDataPath .\v-rising\save-data -serverName "-=QC PVE=- Virgin Tusk Rising" -saveName "world1" -logFile ".\v-rising\logs\VRisingServer.log"
