...
C:\#servers\v-rising\VRisingServer.exe -persistentDataPath .\v-rising\save-data -serverName "-=QC PVE=- Virgin Rising" -saveName "TuskWorld007" -logFile ".\v-rising\logs\VRisingServer.log"
