...
C:\#servers\frozen\FrozenFlameServer.exe -log -LOCALLOGTIMES -MetaGameServerName="-=°Qc|Fr°=- Tusken Flame Server" -ip=184.162.16.65 -Port=27018 -queryPort=27019 -RconPort=25575 -RconPassword=ginette12
